...
if choice == 'Admin':
    ...
    if st.sidebar.checkbox("Login"):
        ...
        if result:
            ...
            choose = option_menu("Menu", ["Beranda", "Tentang", "Unggah", "Kamera", "Informasi", "Dataset"],
...
# Beranda PAGE
            if choose == 'Informasi':
                st.markdown(
                    "<h1 style='text-align: center; color: white;'>Informasi & Cara penggunaan Aplikasi</h1>", unsafe_allow_html=True)
                ...
                st.markdown(
                    "<h1 style='text-align: center; color: white;'>Devina Humaira Putri (1857301065)</h1>", unsafe_allow_html=True)
                st.markdown(
                    "<h1 style='text-align: center; color: white;'>Rancang Bangun Sistem Identifikasi Kesegaran Ikan Berdasarkan Citra Mata Menggunakan SVM (Support Vector Machine)</h1>", unsafe_allow_html=True)
...
if choice == 'User':
    choose2 = option_menu("Menu", ["Beranda", "Tentang", "Unggah", "Kamera", "Dataset"],
                          icons=['house-door', 'info-circle', 'upload',
...
# Beranda PAGE
    if choose2 == 'Unggah':
        ...
        if st.button('PREDIKSI'):
            CATEGORIES = ['busuk', 'kurang segar', 'segar', 'tidak segar']
            st.write('Hasil...')
            flat_data = []
            img = np.array(cropped_img)
            img_resized = resize(img, (100, 100, 3))
